...
public class TestEjercicio1 {
	...
	// Este ejercicio es primo hermano de 1 y algunos métodos casan con el 2
	...
	private static Integer nMaxIter = 10000; // n máximo para el fibonacci no exponencial
	...
	private static List<Trio<Function<Integer, Number>, TipoAjuste, String>> metodosBigInteger = 
			List.of(
				Trio.of(Ej1::factorialBI, TipoAjuste.POWERANB, "FibRec_BigInteger")
			);
	
	private static List<Trio<Function<Integer, Number>, TipoAjuste, String>> metodosDouble = 
			List.of(
					Trio.of(Ej1::factorialD, TipoAjuste.POWERANB, "FibRec_Double")
			);
